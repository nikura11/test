...
street_number = input("Enter Street: ")
subd_location = input("Enter Subdivision: ")
...
file_input.send_keys("C:/Users/143/Desktop/scrcpy-win64-v1.25/ID/abalos.jpg")

file_input = driver.find_element(By.ID, "upload-form-selfie1")
# Send the file path to the file input element
file_input.send_keys("C:/Users/143/Desktop/scrcpy-win64-v1.25/ID/selfie.jpg")
sleep(3)
wait = WebDriverWait(driver, 10)
